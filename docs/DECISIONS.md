...
- **Context:** Independent Item 10A review found that the initial software ledger scoped exposure to `experiment_id + sealed_binding` and used current-head FROZEN verification when rechecking retained release evidence. That allowed a different experiment to treat previously observed data as pristine and prevented complete audit verification after the authorized experiment advanced through Item 8.
...
- **Owner and approver:** Project owner through explicit Stage 1B Item 10A independent-review-fix authorization dated 2026-09-11.
