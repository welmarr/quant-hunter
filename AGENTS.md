...
Quant Hunter is a long-horizon project to build an independent, scientifically defensible quantitative-research and market-discovery laboratory. It is not currently a trading bot. The documentation architecture is the present milestone; do not implement trading strategies or begin Stage 1 infrastructure work without a subsequent, explicit request.
