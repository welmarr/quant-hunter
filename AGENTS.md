...
Quant Hunter is a long-horizon project to build an independent, scientifically defensible quantitative-research and market-discovery laboratory. It is not currently a trading bot. The Stage 0 documentation architecture is complete, but the repository remains pre-Stage 1; do not implement trading strategies or begin Stage 1 infrastructure work without a subsequent, explicit request.
